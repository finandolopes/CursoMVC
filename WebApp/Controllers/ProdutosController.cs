...
namespace WebApp.Controllers
{
    public class ProdutosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Descricao,Preco,CategoriaId")] Produto produto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(long id, [Bind("Id,Nome,Descricao,Preco,CategoriaId")] Produto produto)
        {
            if (id != produto.Id)
            {
                return NotFound();
